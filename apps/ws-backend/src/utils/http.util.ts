...
const allowedOrigins = configuredOrigins.length > 0 ? configuredOrigins : fallbackLocalOrigins
...
export function withCorsHeaders(req: RequestLike, headers: Record<string, string> = {}) {
