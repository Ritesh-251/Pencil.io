...
import { issueRoomMediaToken, startTranscription, stopTranscription } from "../controller/media.controller";
...
router.post("/:roomId/join-requests/:requestId/approve", authMiddleware, approveJoinRequest);
router.post("/:roomId/join-requests/:requestId/reject", authMiddleware, rejectJoinRequest);
